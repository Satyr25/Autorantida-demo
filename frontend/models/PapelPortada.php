 ...
 * @property int $portada_gramaje_id
 * @property int $tamano_id
 * @property float $precio
 *
 * @property PortadaGramaje $portadaGramaje
...
class PapelPortada extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['portada_tipo_id', 'portada_papel_id', 'portada_gramaje_id', 'tamano_id', 'precio'], 'required'],
            [['portada_tipo_id', 'portada_papel_id', 'portada_gramaje_id', 'tamano_id'], 'integer'],
            [['precio'], 'number'],
            [['portada_gramaje_id'], 'exist', 'skipOnError' => true, 'targetClass' => PortadaGramaje::className(), 'targetAttribute' => ['portada_gramaje_id' => 'id']],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'portada_gramaje_id' => 'Portada Gramaje ID',
            'tamano_id' => 'Tamano ID',
            'precio' => 'Precio',
        ];
    }
    ...
    /**
     * Gets query for [[PortadaGramaje]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getPortadaGramaje()
    {
        return $this->hasOne(PortadaGramaje::className(), ['id' => 'portada_gramaje_id']);
    }
